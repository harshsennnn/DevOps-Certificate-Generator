...
//         // Allow both localhost:5173 (dev) and port 80 (prod)
//         allowedOrigins := []string{
//             "http://localhost:5173",
//             "http://localhost",
//             "http://127.0.0.1",
//             "http://yourdomain.com", // replace with real domain if hosted
//         }

//         // Match and set CORS header if the request's Origin is allowed
...
// 	tmplPath := "templates/companyA.json" // Adjust this path as needed
